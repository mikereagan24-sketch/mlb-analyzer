...
function buildGame(gameRow, settings) {
  ...
  try {
    if (q.getBullpenWobaBlended) {
      ...
      var aBp = q.getBullpenWobaBlended(awayAbbr, awaySp, homeLU, bpS, bpW, wProj, wAct, gameRow.game_date);
      var hBp = q.getBullpenWobaBlended(homeAbbr, homeSp, awayLU, bpS, bpW, wProj, wAct, gameRow.game_date);
